//
//  PCOAnnouncerMainTableViewController.m
//  Announcer
//
...
@interface PCOAnnouncerMainTableViewController ()

@end

@implementation PCOAnnouncerMainTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	cell.detailTextLabel.text = feedUrl;
